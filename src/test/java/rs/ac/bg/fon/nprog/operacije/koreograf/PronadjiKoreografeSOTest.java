...
class PronadjiKoreografeSOTest extends ApstraktnaSOTest{
	
	PronadjiKoreografeSO operacija;
	
	@BeforeEach
	void setUp() throws Exception {
		operacija=new PronadjiKoreografeSO(repository);
	}
	...
	void testExecuteOperation() {
		try {
			...
			when(repository.pronadji(any())).thenReturn(listaKoreografa);
